<template>
    <div id="tamMain">
        ...
        <img id="titleImg" src="../../../static/obj_img/temple_img/dingzhi_photo_1.png">
        <div id="manTia">
            <div>定制活动</div>
        </div>
        ...
        <div class="mass_info">
            ...
            <img class="mass_img" src="../../../static/obj_img/temple_img/dingzhi_photo_2.png">
            <div class="mass_more" @click="routerGo('/cpr')">MORE ></div>
        </div>
        <div class="mass_info">
            <div class="mass_title">团建活动定制</div>
            <div class="mass_text">邀请20至200位好朋友参加一场值得回忆的主题派对，举起香醇的红酒，为单身、为生日、为即将诞生的宝宝而庆祝吧！</div>
            <img class="mass_img" src="../../../static/obj_img/temple_img/dingzhi_photo_3.png">
