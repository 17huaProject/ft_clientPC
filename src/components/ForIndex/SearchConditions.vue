<template>
    <div id="SC_compose_Area">
        <div v-show="modelNum" class="search_conditions_box">
            ...
            <div class="calender_setTime" @click="selectCalendar()">
                <div class="select_day">{{afterweek.month}}月{{afterweek.day}}日 周{{afterweek.week}}</div>
                <!--<div class="select_mtwk">
                                <div></div>
                                <div></div>
                            </div>-->
            ...
            <img class="select_arr" src="../../../static/obj_img/home_icon_ArrDown.png">
        </div>
        <!-- tips -->
        ...
        <div v-show="!modelNum" class="search_conditions_box_2">
            <div class="search_conditions_box_21">
                <el-date-picker v-model="value3" format="yyyy-MM-dd" :clearable="false" align="center" type="datetimerange" :picker-options="pickerOptions2" placeholder="选择时间范围"></el-date-picker>
                <div class="condition_peoples_21" @click="selectCalendar()">
                    <div class="select_day_2">{{today.month}}月{{today.day}}日 周{{today.week}}</div>
                    <!--<div class="select_mtwk">
                                    <div>{{today.month}}月</div>
                                    <div>周{{today.week}}</div>
                                </div>-->
                </div>
                <img class="condition_peoples_2_img" src="../../../static/obj_img/webDte_img/home_blog_icon_03.png">
                <div class="condition_peoples_21" @click="selectCalendar()">
                    <div class="select_day_2">{{afterweek.month}}月{{afterweek.day}}日 周{{afterweek.week}}</div>
                    <!--<div class="select_mtwk">
                ...
                <div class="consLine"></div>
                <div class="condition_peoples_21" @click="selectCount(0,2)">{{guest}}人参加<img class="condition_peoples_2_img" src="../../../static/obj_img/webDte_img/home_city_icon.png"></div>
            </div>
        </div>
    </div>
</template>
...
export default {
    data() {
        return {
            ...
            value3: [new Date(this.$store.state.ChangeCalendar.startTime), new Date(this.$store.state.ChangeCalendar.endTime)],
        }
    },
    computed: {
...
.condition_peoples_21:hover {
    text-shadow: 0 0 2px #999999
}

.condition_peoples_21 img {
    margin: 4px 0 0 5px;
}
