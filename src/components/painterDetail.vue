<template>
    <div class="detail_info">
        ...
        <div class="img_Title_painter">
            <img :src="painter.big_img.indexOf('http')<0?this.$store.state.SyetemBaseConfig.image_prefix+painter.big_img:''+painter.big_img.replace('http:','')">
        </div>
        <div class="Tib_bar_p">
