<template>
    <div class="detail_info">
        <img class="Like_cover_detail" v-show="likeId==''" @click="conectionBYid(true)" src="../../static/obj_img/list_Collect_icon_.png">
        <img class="Like_cover_detail" v-show="likeId!=''" @click="conectionBYid(false)" src="../../static/obj_img/list_Collected_icon.png">
        <div class="img_Title_detail">
        ...
        <div v-if="!isWeiXin()" class="Content_info_actv ActiveFlexCenter">
            <vue-qr :text="textA" size="200" dotScale="1" logoSrc="//image.17hua.me/upload/image/201709/1505371271440500.png" logoCornerRadius="1"></vue-qr>
            <div>微信扫描二维码即可查看活动哦</div>
        </div>
        ...
        <div class="Pay_bottom" v-if="acti.event_status=='ONSALE'&&isWeiXin()">
        ...
        <div class="Pay_bottom" v-else-if="acti.event_status=='PRESALE'&&isWeiXin()">
...
export default {
    data() {
        return {
            ...
            textA:'http://wx.17hua.me/#/dt?actinfo='+this.$route.query.actinfo,
            likeId: '',
            closeTime: {
                d: '',
                h: '',
    ...
    methods: {
        ...
        CreatOrder() {
            ...
            //     OrderInfo: this.acti,
            // }
            // comInfo.OrderInfo.img_title = this.acti.big_img.indexOf('http') < 0 ? this.$store.state.SyetemBaseConfig.image_prefix + this.acti.big_img : '' + this.acti.big_img;
            ...
            location.href = '//wx.17hua.me/#/dt?actinfo=' + this.$route.query.actinfo
        },
        getMenberList() {
        ...
        setActiveDetail(data) {
            if (data.errcode === 200) {
                ...
                let share = {
                    sharetitle: '我要去参加：' + this.acti.event_name + ' | 一起画',
                    sharelink: 'wx.17hua.me/#/dt?actinfo=' + this.$route.query.actinfo,
