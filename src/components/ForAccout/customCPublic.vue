<template>
    <div id="tamMain">
        ...
        <img id="titleImg" src="../../../static/obj_img/temple_img/compay_photo_1.png">
        <div id="manTia">
            <div>团建活动定制</div>
        </div>
        <div id="manTia_Tschild">公司聚会不一定只有唱歌吃饭，在秦颂愉悦的绘画活动中，加深相互认识了解，体验创意和乐趣，加强团队凝聚力。</div>
        <div class="mass_titles">团建为什么选择一起画</div>
        <div class="mess_Content">
            <img class="mess_img" src="../../../static/obj_img/temple_img/company_photo_2.png">
            <div class="mess_info">
                <div>绘画如此简单</div>
        ...
        <div class="mess_Content">
            ...
            <img class="mess_img" src="../../../static/obj_img/temple_img/company_photo_3.png">
        </div>
        <div class="mess_Content">
            <img class="mess_img" src="../../../static/obj_img/temple_img/company_photo_4.png">
            <div class="mess_info">
                <div>创意改变生活</div>
