<template>
    <div class="detail_info">
        ...
        <div class="img_Title_address">
            <img :src="addrInfo.big_img.indexOf('http')<0?this.$store.state.SyetemBaseConfig.image_prefix+addrInfo.big_img:''+addrInfo.big_img.replace('http:','')">
        </div>
        ...
        <div class="MainTitle_bar">
            <div class="altic_painter painter_s" v-html="addrInfo.venue_desc">

            </div>
            <div class="painter_s" v-html="this.unescape(addrInfo.content)">
