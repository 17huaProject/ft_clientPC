<template>
    <div id="tamMain">
        ...
        <img id="titleImg" src="../../../static/obj_img/temple_img/personal_dingzhi_photo_.png">
        <div id="manTia">
            <div>私人活动定制</div>
        </div>
        ...
        <div class="mess_Content">
            <img class="mess_img" src="../../../static/obj_img/temple_img/personal_photo_2.png">
            <div class="mess_info">
                <div>白手套服务</div>
        ...
        <div class="mess_Content">
            ...
            <img class="mess_img" src="../../../static/obj_img/temple_img/personal_photo_3.png">
        </div>
        <div class="mess_Content">
            <img class="mess_img" src="../../../static/obj_img/temple_img/personal_photo_4.png">
            <div class="mess_info">
                <div>独特并有趣</div>
